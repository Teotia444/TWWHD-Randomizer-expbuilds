...
{
    YAML::Node entrancePairs;
    if(!LoadYAML(entrancePairs, Utility::get_data_path() / "logic/entrance_shuffle_table.yaml", true)) {
        ErrorLog::getInstance().log("Failed to load entrance_shuffle_table.yaml");
        return {};
    }
